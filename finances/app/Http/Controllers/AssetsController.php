...
class AssetsController extends Controller
{
    ...
    $request->validate([
           'inp_ca' => 'required|string|in:Cash and Cash Equivalents,Investments,Receivables,Inventories',  // Removed trailing comma
         'inp_tca' => 'required|numeric|min:0',  // Numeric and minimum value validation
         ...
         'inp_tna' => 'required|numeric|min:0',  // Numeric and minimum value validation
]);
